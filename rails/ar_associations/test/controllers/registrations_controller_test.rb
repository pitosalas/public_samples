...
class RegistrationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create registration" do
    assert_difference('Registration.count') do
      post registrations_url, params: { registration: { course_id: @registration.course_id, student_id: @registration.student_id } }
    end
  ...
  test "should update registration" do
    patch registration_url(@registration), params: { registration: { course_id: @registration.course_id, student_id: @registration.student_id } }
